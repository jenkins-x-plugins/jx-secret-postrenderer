...
export JENKINS_X_URL='https://dashboard-jx.dev.jenkins-x.me/jenkins-x-plugins/jx-secret-postrenderer/main/1'
...
export MINK_IMAGE='ghcr.io/jenkins-x/jx-secret-postrenderer:0.0.6'
